...
function setup(){
  ...
  ghostblueI = createSprite(200,300,25,25)
  ghostblueI.scale = 0.25
  ghostblueI.velocityY = -2
  ghostblueI.velocityX = 2
  ghostblueI.velocityY = 2
  ghostblueI.velocityX = -2

  ghostredI = createSprite(200,100,25,25)
  ghostredI.scale = 0.25
  ghostredI.velocityY = -2
  ghostredI.velocityX = 2
  ghostredI.velocityY = 2
  ghostredI.velocityX = -2

  ghostpinkI = createSprite(500,100,25,25)
  ghostpinkI.scale = 0.25
  ghostpinkI.velocityY = -2
  ghostpinkI.velocityX = 2
  ghostpinkI.velocityY = 2
  ghostpinkI.velocityX = -2

  ghostyellowI = createSprite(750,100,25,25)
  ghostyellowI.scale = 0.25
  ghostyellowI.velocityY = -2
  ghostyellowI.velocityX = 2
  ghostyellowI.velocityY = 2
  ghostyellowI.velocityX = -2
  
  ghostblue1I = createSprite(200,300,25,25)
  ...
  ghostred1I = createSprite(200,100,25,25)
  ...
  ghostpink1I = createSprite(500,100,25,25)
  ghostpink1I.scale = 0.25
  ghostpink1I.velocityY = -3
  ghostpink1I.velocityX = 2
  ghostpink1I.velocityY = 3
  ghostpink1I.velocityX = -2

  ghostyellow1I = createSprite(750,100,25,25)
  ghostyellow1I.scale = 0.25
  ghostyellow1I.velocityY = -3
  ghostyellow1I.velocityX = 2
  ghostyellow1I.velocityY = 3
  ghostyellow1I.velocityX = -2
